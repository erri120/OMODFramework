...
namespace OMODFramework.Scripting.ScriptHandlers.CSharp.InlinedScripts
{
    internal class DarNifiedUI : IScript
    {
        ...
        string[] menuselections = new string[]
        {
            "Breathmeter",
            "Info Menu",
            "Subtitles",
        ...
        string[] customoptions = new string[]
        {
            "Custom Font 1",
            "KCAS-AF Menus",
        ...
        string[] font1selections = new string[]
        {
            "Default",
            "!Sketchy_Times_36",
            "Dundalk_28",
        ...
        void IScript.Execute(IScriptFunctions sf)
        {
            ...
            {
                MessageBox.Show(
                    "This mod must be installed with Oblivion Mod Manager version " + requiredver.ToString() +
                    " or higher to prevent script errors.",
            ...
            if (showReminder)
                MessageBox.Show(
                    "OBMM will now ask for confirmation as Oblivion.ini is modified to implement your choices.\nBe sure to click 'Yes' when asked. Hold down CTRL while pressing the button to choose yes/no to all.",
                    "Modifying the ini", MessageBoxButtons.OK, MessageBoxIcon.Information);
        } //IScript.Execute
                ...
                switch (opt.ToString())
                {
                    ...
                    case "KCAS-AF Menus":
                        if (insstats && !ModActive(oxp))
                            sf.EditXMLReplace("menus\\prefabs\\darn\\stats_config.xml", "<_KCAS> &false; </_KCAS>",
                                "<_KCAS> &true; </_KCAS>");
        ...
        private void InitPage(Page page)
        {
            ...
            {
                MessageBox.Show("Exception: " + e.Message, "DUI Install - Error in InitPage()", MessageBoxButtons.OK,
        ...
        private void GetPlayerName()
        {
            ...
            if (pn != "")
                sf.EditXMLReplace("menus\\options\\credits_menu.xml", "<string>You</string>",
                    "<string>" + pn + "</string>");
        }
